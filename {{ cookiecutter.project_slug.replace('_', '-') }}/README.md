...
A skeleton deck ships in [`slides.md`](slides.md) — cover, whoami, agenda, one
section divider, one content slide, and a closing slide. Fill in your own
content in `slides.md`, then `make build` writes the PDF to
`build/slides.pdf`.
